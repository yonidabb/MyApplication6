...
public class IranQuestion4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_iran_question4);
        ...
        submit.setOnClickListener(v -> {
            if (answer.getText().toString().trim().equalsIgnoreCase("persia")) {
                Toast.makeText(this, "✅ עברת שלב", Toast.LENGTH_SHORT).show();
                startActivity(new Intent(this, IranQuestion5Activity.class));
                finish();
            } else {
